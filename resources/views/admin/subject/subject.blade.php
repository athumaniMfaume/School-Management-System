    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Subject</h1>
            <a href="{{route('subject.read')}}" class="btn btn-primary mt-2"> View Subject</a>
          </div>
          <div class="col-sm-6">
...
@endif
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Enter subject name">
            @error('name')
