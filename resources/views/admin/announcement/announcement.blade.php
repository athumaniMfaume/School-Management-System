    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Announcement</h1>
            <a href="{{route('announcement.read')}}" class="btn btn-primary mt-2"> View Announcement</a>
          </div>
          <div class="col-sm-6">
              ...
              <form action="{{ route('announcement.store') }}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="academicYear">Message</label>
                    ...
                    <div class="form-group">
                        <label for="academicYear">BroadCast To</label>
