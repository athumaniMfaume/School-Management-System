      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a href="{{route('class.read')}}" class="btn btn-primary mt-2"> View Class</a>
          </div>
          <div class="col-sm-6">
              ...
              <form action="{{route('class.store')}}" method="post">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="name"  class="form-control @error('name') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter Class">
                  </div>
                  @error('name')
                      <p class="text-danger">
                        {{$message}}
