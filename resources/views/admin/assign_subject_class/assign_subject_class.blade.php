  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Assign Subject Class</h1>
            <a href="{{route('subject_class.read')}}" class="btn btn-primary mt-2"> View Assign Subject Class</a>

          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
              <li class="breadcrumb-item active">Assign Subject Class</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            @endif
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('subject_class.store')}}" method="post">
                @csrf
