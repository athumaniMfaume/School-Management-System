    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Academic Year</h1>
            <a href="{{route('academic-year.read')}}" class="btn btn-primary mt-2"> View Academic</a>
          </div>
          <div class="col-sm-6">
              ...
              <form action="{{ route('academic-year.store') }}" method="post">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="academicYear" placeholder="Enter academic year">
                        @error('name')
