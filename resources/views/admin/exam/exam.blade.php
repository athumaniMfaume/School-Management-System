    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Exam</h1>
            <a href="{{route('exam.read')}}" class="btn btn-primary mt-2"> View Exam</a>
              ...
              <form action="{{route('exam.store')}}" method="post">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <div class="form-group col-md-4">
                        <label for="name">Exam's Name</label>
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Enter Exam Name">
                        @error('name')
                    ...
                    <div class="form-group col-md-4">
                        <label for="name">Exam's Term</label>
                        <input type="text" name="term" class="form-control @error('term') is-invalid @enderror" id="name" placeholder="Enter Exam Term">
                        @error('term')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        <label for="admission_date">Exam Date</label>
                        <input type="date" name="date" class="form-control @error('date') is-invalid @enderror" id="admission_date">
                        @error('date')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
