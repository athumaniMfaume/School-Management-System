    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Exam</h1>
            <a href="{{route('exam_result.read')}}" class="btn btn-primary mt-2"> View Exam Results</a>

          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
              <li class="breadcrumb-item active">Assign Exam Results</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            @endif
              <div class="card-header">
                <h3 class="card-title">Assign Exam Results</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('exam_result.store')}}" method="post">
                @csrf
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select class="form-control @error('user_id') is-invalid @enderror" name="user_id" id="">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select class="form-control @error('subject_id') is-invalid @enderror" name="subject_id" id="">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <input type="number" name="score" class="form-control @error('score') is-invalid @enderror" id="name" placeholder="Enter Score">
                        @error('score')
