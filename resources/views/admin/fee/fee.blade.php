    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Fee Head</h1>
            <a href="{{route('fee.read')}}" class="btn btn-primary mt-2"> View Fee Head</a>
          </div>
          <div class="col-sm-6">
              ...
              <form action="{{route('fee.store')}}" method="post">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="name"  class="form-control @error('name') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter Fee">
                  </div>
                  @error('name')
                      <p class="text-danger">
                        {{$message}}
