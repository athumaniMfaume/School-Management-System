    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Fee Structure</h1>
            <a href="{{route('fee_structure.read')}}" class="btn btn-primary mt-2"> View Fee Structure</a>
          </div>
          <div class="col-sm-6">
              ...
              <form action="{{route('fee_structure.store')}}" method="post">
                ...
                <div class="card-body">
                    <div class="row">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select class="form-control @error('class_id') is-invalid @enderror" name="class_id" id="">
                    ...
                    @enderror
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select class="form-control @error('fee_head_id') is-invalid @enderror" name="fee_head_id" id="">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="april"  class="form-control @error('april') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter April Fee ">
                    @error('april')
                    <p class="text-danger">
                      {{$message}}
                    </p>
                @enderror
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="may"  class="form-control @error('may') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter May Fee">
                    @error('may')
                    <p class="text-danger">
                      {{$message}}
                    </p>
                @enderror
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="june"  class="form-control @error('june') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter June Fee">
                    @error('june')
                    <p class="text-danger">
                      {{$message}}
                    </p>
                @enderror
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="july"  class="form-control @error('july') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter July Fee">
                    @error('july')
                    <p class="text-danger">
                      {{$message}}
                    </p>
                @enderror
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="august"  class="form-control @error('august') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter August Fee">
                    @error('august')
                    <p class="text-danger">
                      {{$message}}
                    </p>
                @enderror
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="september"  class="form-control @error('september') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter September Fee">
                    @error('september')
                    <p class="text-danger">
                      {{$message}}
                    </p>
                @enderror
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="october"  class="form-control @error('october') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter October Fee">
                    @error('october')
                    <p class="text-danger">
                      {{$message}}
                    </p>
                @enderror
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="november"  class="form-control @error('november') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter November Fee">
                    @error('november')
                      <p class="text-danger">
                        {{$message}}
                      </p>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="december"  class="form-control @error('december') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter December Fee">
                    @error('december')
                    <p class="text-danger">
                      {{$message}}
                    </p>
                @enderror
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="january"  class="form-control @error('january') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter January Fee">
                    @error('january')
                      <p class="text-danger">
                        {{$message}}
                      </p>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="february"  class="form-control @error('february') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter February Fee">
                    @error('february')
                      <p class="text-danger">
                        {{$message}}
                      </p>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="march"  class="form-control @error('march') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter  March Fee">
                    @error('march')
                    <p class="text-danger">
                      {{$message}}
                    </p>
