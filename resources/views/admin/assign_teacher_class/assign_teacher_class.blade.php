  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Assign Teacher Class</h1>
            <a href="{{route('teacher_class.read')}}" class="btn btn-primary mt-2"> View Assign Teacher Class</a>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
              <li class="breadcrumb-item active">Assign Teacher Subject Class</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            @endif
              <div class="card-header">
                <h3 class="card-title">Assign Teacher Class</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
