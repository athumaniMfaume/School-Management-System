...
@endif
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('time_table.store') }}" method="post">
                @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($day as $index => $item)
                                <tr>
                                    <td>{{ $item->name }}</td>
                                    <input type="hidden" name="timetable[{{ $index }}][day_id]" value="{{ $item->id }}">
                                    <td>
                                        <input type="time" name="timetable[{{ $index }}][start_time]" value="{{ old("timetable.$index.start_time") }}">
                                        @error("timetable.$index.start_time")
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </td>
                                    <td>
                                        <input type="time" name="timetable[{{ $index }}][end_time]" value="{{ old("timetable.$index.end_time") }}">
                                        @error("timetable.$index.end_time")
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </td>
                                    <td>
                                        <input type="number" name="timetable[{{ $index }}][room_no]" placeholder="Room Number" value="{{ old("timetable.$index.room_no") }}">
                                        @error("timetable.$index.room_no")
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </td>
                                </tr>
